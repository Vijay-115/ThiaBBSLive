...
const Categories = () => {
  ...
  const totalPages = Math.ceil(filteredCategories.length / itemsPerPage);
    ...
    return (
      ...
      <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 text-center">Delete Category?</h3>
      <p className="text-gray-600 dark:text-gray-300 text-center mb-6">Are you sure you want to delete this category? This action cannot be undone.</p>
      <div className="flex gap-3 w-full">
        ...
        >
          Cancel
                        ...
                        {/* Enhanced Add Category & Search Bar UI (replicated from admin) */}
