                    ...
                    <main>
                        ...
                        >
                            <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-gray-900 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 max-w-sm mx-auto">
                              ...
                              <h3 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 text-center">Delete SubCategory?</h3>
                              <p className="text-gray-600 dark:text-gray-300 text-center mb-6">Are you sure you want to delete this subcategory? This action cannot be undone.</p>
                        ...
                        {/* Enhanced Add SubCategory & Search Bar UI (replicated from admin) */}
