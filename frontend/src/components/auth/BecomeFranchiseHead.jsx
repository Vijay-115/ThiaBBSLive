...
const BecomeFranchiseHead = () => {
    ...
    const validateVendor = () => {
        ...
        // Basic validations
        if (!vendorData.vendor_fname) formErrors.vendor_fname = "Franchise Head first name is required";
                    ...
                    <div className="border-[20px] border-transparent rounded-[20px] dark:bg-gray-900 bg-white shadow-lg p-5 m-2">
                        ...
                        <form className="grid grid-cols-2 gap-x-4" onSubmit={handleVendorSubmit} encType="multipart/form-data">
                            ...
                            <div className="col-span-1 mt-3">
                                <label className="block text-[14px] font-medium text-secondary mb-[8px]">Franchise Head First Name</label>
                                <input name="vendor_fname" type="text" placeholder="Enter Franchise Head First Name"
                            ...
                            <div className="col-span-1 mt-3">
                                <label className="block text-[14px] font-medium text-secondary mb-[8px]">Franchise Head Last Name</label>
                                <input name="vendor_lname" type="text" placeholder="Enter Franchise Head Last Name"
                                    className={`border p-[9.85px] w-full rounded-lg`}
                                    onChange={handleChange} value={vendorData.vendor_lname} />
                            </div>
                            <div className="col-span-1 mt-3">
                                <label className="block text-[14px] font-medium text-secondary mb-[8px]">Franchise Head DOB</label>
                            ...
                            <h3 className="col-span-2 block text-[18px] font-medium text-primary mt-[20px]  mb-[8px]">Franchise Head Profile</h3>                            
