...
// // Local fallback data (for dev/demo)
...
//     image:
//       "https://tse3.mm.bing.net/th/id/OIP.fgk1nqCD-Ufjxm9SPdkjiwHaEg?cb=thfc1&rs=1&pid=ImgDetMain&o=7&rm=3",
//     assured: true,
//     gstInvoice: true,
//     deliveryIn1Day: true,
//     ram: 8,
...
//     image:
//       "https://th.bing.com/th/id/R.de59b2f20d94dba01492b6a6482c5487?rik=dDopPeiZJueYYA&riu=http%3a%2f%2fpluspng.com%2fimg-png%2fpng-mobile-phone-smartphone-cell-phone-mobile-phone-iphone-icon-1024.png&ehk=56gvwYNk%2b1up7wY8AwSozfEdvUc0Dtxp9z5F%2fmwbKrE%3d&risl=&pid=ImgRaw&r=0",
//     assured: true,
//     gstInvoice: false,
...
//     image:
//       "https://tse2.mm.bing.net/th/id/OIP.VTsDnaylVd3iYMwemwTlFgHaI3?cb=thfc1&w=500&h=599&rs=1&pid=ImgDetMain&o=7&rm=3",
//     assured: false,
//     gstInvoice: false,
//     deliveryIn1Day: true,
//     ram: 4,
...
export default function ProductListingFull({ products: propProducts }) {
  // ------- Filters & UI state -------
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Fallback to local
        setAllBrands(Array.from(new Set(sampleProducts.map((p) => p.brand))));
        setRamOptions(
          Array.from(new Set(sampleProducts.map((p) => p.ram))).sort(
            (a, b) => a - b
          )
        );
  ...
  // Use products from state (API or local)
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl font-semibold">
                {useLocal ? "Vivo T4 5G" : "All Products"}
              </h1>
