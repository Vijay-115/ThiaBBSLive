        ...
        <>
            <div className="grid lg:grid-cols-2 gap-6 px-8 py-8 min-h-screen cardSlide align-items-center">
                <div className="flex flex-col justify-center">
                    <h2 className="text-[36px] font-bold text-yellow-600 mb-6">Introducing the Thia Secure Plan</h2>

                    <p className="font-Poppins text-[14px] text-secondary mb-5">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>

                    <div className="flex flex-col justify-center">
                        <ul className="space-y-3 text-sm text-gray-700">
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-yellow-600 text-[16px] mr-2"></i>
                                <p>Pay only <strong>40% upfront</strong> and reserve your jewelry</p>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-yellow-600 text-[16px] mr-2"></i>
                            ...
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-yellow-600 text-[16px] mr-2"></i>
                                <p>Pay the remaining <strong>60% in 12 months via Golldex</strong> — no interest</p>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-yellow-600 text-[16px] mr-2"></i>
                                <p><strong>We pay the interest</strong> to the bank on your behalf</p>
                            </li>
                            <li className="flex items-start">
                                <i className="ri-checkbox-circle-fill text-yellow-600 text-[16px] mr-2"></i>
                                <p>Product delivered to your doorstep with <strong>BIS Certificate</strong></p>
                            </li>
                        </ul>
                        <div className="mt-6 flex flex-col sm:flex-row gap-4">
                            <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-medium px-6 py-2 rounded shadow" fdprocessedid="eo05zum">Apply Now</button>
                            <button className="bg-white text-yellow-600 hover:text-yellow-700 border border-yellow-500 font-medium px-6 py-2 rounded shadow" fdprocessedid="fde6mb">Know More</button>
                        </div>
                    </div>
